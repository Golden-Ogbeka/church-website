...
function EventForm() {
  ...
  return (
    <section className="bg-[#FEF6F0] py-12 px-6 sm:px-16 px-6 text-blue-900">
      {/* ======================= && •FORM HEADER• && ====================== */}
        ...
        <div className="grid grid-cols-1 gap-4 ">
          {[
            ...
            <input
              ...
              className="border border-[#0D57BE]/40 px-4 py-2 rounded-sm focus:ring-2 focus:ring-orange-500 placeholder-[#0D57BE] focus:outline-none shadow-lg h-[49px] font-light"
            />
          ))}
        </div>
